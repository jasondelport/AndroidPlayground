...
public class _IBeacon {
    ...
    protected _IBeacon(_IBeacon otherIBeacon) {
    ...
    protected _IBeacon(String proximityUuid, int major, int minor, int txPower, int rssi) {
    ...
    public _IBeacon(String proximityUuid, int major, int minor) {
        this.proximityUuid = proximityUuid.toLowerCase();
        this.major = major;
        this.minor = minor;
        this.rssi = rssi;
     ...
     */
    public static _IBeacon fromScanData(byte[] scanData, int rssi) {
     ...
     */
    @TargetApi(5)
    public static _IBeacon fromScanData(byte[] scanData, int rssi, BluetoothDevice device) {
        int startByte = 2;
    ...
    public boolean equals(Object that) {
        if (!(that instanceof _IBeacon)) {
            return false;
        }
        _IBeacon thatIBeacon = (_IBeacon) that;
